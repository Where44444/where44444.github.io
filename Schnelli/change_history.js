var _change_filter_date_start = new Date(FILTER_TIME_START);
var _change_filter_date_end = new Date();
function populateChangeHistory() {
    if (document.getElementById("change_history_filter_time") != null) {
...
function clearChangeFilters() {
    ...
    _change_filter_date_start = date0;
    _change_filter_date_end = date1;
    populateChangeHistory();
    saveChangeHistoryFilters();
}
...
function saveChangeHistoryFilters() {
    _change_history_filters[0] = document.getElementById("change_history_filter_time").value;
    _change_history_filters[1] = document.getElementById("change_history_filter_initials").value;
    _change_history_filters[2] = document.getElementById("change_history_filter_type").value;
    _change_history_filters[3] = document.getElementById("change_history_filter_change").value;
    _change_history_filters[4] = document.getElementById("change_history_filter_change_any_field").value;
}