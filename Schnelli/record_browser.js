...
if(populateFromBottom == null)
  ...
  if(populateFromBottom)
    ...
    {
      if(!endFound){
        var nextIndex = getNextContentIndexInSortOrder(populate_indexes[0], _contentSortedReverse);
        if(nextIndex != null)
      ...
      if(endFound)
      {
        var nextIndex = getNextContentIndexInSortOrder(populate_indexes[populate_indexes.length - 1], !_contentSortedReverse);
        if(nextIndex != null)
