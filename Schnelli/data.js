...
+ "<div style='border-bottom: solid 2px #5B6275; height: 70px;'>&nbsp;&nbsp;&nbsp;CUSTOMER<br>&nbsp;&nbsp;&nbsp;ORDER NO. <textarea onfocus='deselectTable();' id='invoice_input_customer_order_no'                                               style='position: absolute; left: 100px;  top: 0px;  width: 570px; height: 60px; font-size: 20px;'></textarea></div>"
+ "  <div style='border-bottom: solid 2px #5B6275; height: 40px;'>&nbsp;&nbsp;&nbsp;NAME              <input type='text' onfocus='deselectTable();' id='invoice_input_name'                                                                       style='position: absolute; left: 100px;  top: 72px; width: 570px; height: 30px; font-size: 20px;'></div>"
+ "  <div style='border-bottom: solid 2px #5B6275; height: 40px;'>&nbsp;&nbsp;&nbsp;ADDRESS           <input type='text' onfocus='deselectTable();' id='invoice_input_address'                                                                    style='position: absolute; left: 100px;  top: 114px;width: 570px; height: 30px; font-size: 20px;'></div>"
+ "  <div style='border-bottom: solid 2px #5B6275; height: 40px;'>&nbsp;&nbsp;&nbsp;CITY, STATE,<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ZIP <input type='text' onfocus='deselectTable();' id='invoice_input_citystatezip' style='position: absolute; left: 100px; top: 156px; width: 570px; height: 30px; font-size: 20px;'></div>"
+ "  &nbsp;&nbsp;&nbsp;PHONE<input type='text' onfocus='deselectTable();' id='invoice_input_phone'                                                                                                                                                style='position: absolute; left: 100px; top: 198px; width: 570px; height: 30px; font-size: 20px;'>"
+ "</div>"
...
+ "  </div>"
+ "</div>"
+ "<textarea onfocus='deselectTable();' class='invoice_div' style='top: 352px; left: 160px; width: 330px; height: 70px;' id='invoice_textarea_specs'></textarea>"
+ "<textarea onfocus='deselectTable();' class='invoice_div' style='top: 352px; left: 510px; width: 180px; height: 70px;' id='invoice_textarea_misc'></textarea>"
