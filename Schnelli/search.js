...
function searchQueryScope(scope, clearResults)
{
  ...
  else
  {
    ...
    for(var i = 0; i < NUM_SEARCH_THREADS; ++i)
    {
      ...
      searchWorker.postMessage([searchstring_any, _content_standard_slice, _content_slice, columnsToSearch, anyChecked, searchstrings_specific, _INDEXES, currentResultsRowsIDs, _DESCRIP1, _DESCRIP2, i, orig_indexStart]);
